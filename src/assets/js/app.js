...
title.textContent.length >= 35 ? title.classList.add("title__size") : title.classList.remove("title__size");
...
const offer__discount = document.querySelector('.offer__discount');
offer__discount.textContent = mainContent[`-83%`];
